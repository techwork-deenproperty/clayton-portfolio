          ...
          <div className="w-full md:max-w-md space-y-6 md:space-y-8">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold text-primary mb-2 sm:mb-4">
                <span className="text-balance">Clayton Padzarandara</span>
              </h1>
            ...
            <p className="text-foreground/80 leading-relaxed text-base sm:text-lg">
              Buying a home in Dubai is a milestone, not a transaction. I believe the journey should be as seamless and vibrant as the lifestyle this city offers. My mission is to provide a deeply personal, focused experience one where your specific tastes, family needs, and aspirations are my sole priority
            </p>

            {/* Social Icons */}
            <div className="flex justify-start gap-4 sm:gap-5">
              <Link
                href="https://www.instagram.com/mc_clayt?igsh=MTMyZnE4azh6bzVqbg=="
                target="_blank"
